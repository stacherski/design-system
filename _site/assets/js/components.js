...
// src/assets/js/components/as-carousel-component.js
var require_as_carousel_component = __commonJS({
  "src/assets/js/components/as-carousel-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      ...
      class ASCarousel extends HTMLElement {
        ...
        init() {
          ...
          this.resize();
          if (this.autorotate) {
            this.autostart = setTimeout(() => this.autoplay(), this.delay * 1e3);
        ...
        dragAction(evt) {
          ...
          this.slider.style.left = parseFloat(this.slider.style.left) + dx + "px";
          evt.preventDefault();
        }
        dragEnd() {
          this.isDragging = false;
        ...
        applyInertia() {
          ...
          const step = () => {
            ...
            this.slider.style.left = parseFloat(this.slider.style.left) + this.velocity * 16 + "px";
        ...
        autoRotate(dir, delay) {
          this.step(dir);
          this.rotateInterval = setInterval(() => this.step(dir), delay * 1e3);
          this.playpausebutton.textContent = "Pause";
        }
        moveSlide(dir) {
          console.log("slide");
          ...
          if (dir) {
            ...
            this.slider.style.left = -this.maxLeft - this.gap - this.slideWidth + "px";
            setTimeout(() => {
              slides[0].remove();
              this.resetPosition();
            }, this.speed);
...
// src/assets/js/components/as-char-counter-component.js
var require_as_char_counter_component = __commonJS({
  "src/assets/js/components/as-char-counter-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-char-counter") === void 0) {
        class ASCharCounter extends HTMLElement {
          ...
          count() {
            ...
            this.broadcastEvent("as-char-counter:count", { id: this.charCounterId, fieldid: this.getAttribute("data-input"), chars, texts });
          }
          isEmpty(obj) {
...
// src/assets/js/components/as-class-toggle-component.js
var require_as_class_toggle_component = __commonJS({
  "src/assets/js/components/as-class-toggle-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-class-toggle") === void 0) {
...
// src/assets/js/components/as-command-menu-component.js
var require_as_command_menu_component = __commonJS({
  "src/assets/js/components/as-command-menu-component.js"(exports, module) {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-command-menu") === void 0) {
        class ASCommandMenu extends HTMLElement {
          ...
          commandsHeadings() {
            this.headings = /* @__PURE__ */ new Set();
...
var require_as_contrast_checker_component = __commonJS({
  "src/assets/js/components/as-contrast-checker-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-contrast-checker") === void 0) {
        class ASContrastChecker extends HTMLElement {
          ...
          generateColoursSet() {
            ...
            const coloursSet = /* @__PURE__ */ new Set();
          ...
          generateColourPairs(coloursSet) {
            const colourPairsSet = /* @__PURE__ */ new Set();
            const c = [...coloursSet];
          ...
          getRGBFromHex(color) {
            var rgb = Object.create(this.rgbClass), rVal, gVal, bVal;
          ...
          calculateSRGB(rgb) {
            var sRGB = Object.create(this.rgbClass), key;
            for (key in rgb) {
          ...
          calculateLRGB(rgb) {
            ...
            var lRGB = Object.create(this.rgbClass), key, val = 0;
            for (key in sRGB) {
          ...
          getContrastRatioForHex(foregroundColor, backgroundColor) {
            var color1 = this.getRGBFromHex(foregroundColor), color2 = this.getRGBFromHex(backgroundColor), l1RGB = this.calculateLRGB(color1), l2RGB = this.calculateLRGB(color2), l1 = this.calculateLuminance(l1RGB), l2 = this.calculateLuminance(l2RGB);
...
// src/assets/js/components/as-contrast-component.js
var require_as_contrast_component = __commonJS({
  "src/assets/js/components/as-contrast-component.js"() {
    if (!window.AS.ASContrast) {
      class ASContrast {
        constructor(el, colours2) {
          this.el = el;
          this.colours = colours2 | [];
          this.init();
        }
        init() {
          ...
          colours.forEach((colour) => {
            ...
            info.addEventListener("click", () => {
              navigator.clipboard.writeText(colour).then(() => new Toast(`'${colour}' copied`, 1.5)).catch((err) => new Toast(`Failed to copy: ${err}`));
            });
            this.el.append(info);
          });
        }
...
// src/assets/js/components/as-copy-component.js
var require_as_copy_component = __commonJS({
  "src/assets/js/components/as-copy-component.js"() {
    if (!window.AS.ASCopy) {
      class ASCopy2 {
        constructor(el) {
        ...
        init() {
          this.el.addEventListener("click", (e) => {
            navigator.clipboard.writeText(e.target.innerText).then(() => new Toast(`'${e.target.innerText}' copied`, { type: "info", timeout: 3e3 })).catch((err) => new Toast(`Failed to copy: ${err}`, { type: "error" }));
          });
        }
      }
      window.AS.ASCopy = ASCopy2;
      window.ASCopy = ASCopy2;
    }
  }
});

// src/assets/js/components/as-date-picker-component.js
var require_as_date_picker_component = __commonJS({
  "src/assets/js/components/as-date-picker-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-date-picker") === void 0) {
        class ASDatePickerElement extends HTMLElement {
          connectedCallback() {
            queueMicrotask(() => {
              ...
              this.date = this.input.value || (/* @__PURE__ */ new Date()).toISOString().split("T")[0];
          ...
          populateMonthSelect() {
            ...
            for (let m = 1; m <= 12; m++) {
              ...
              option.text = new Date(2e3, m - 1, 1).toLocaleString(this.locale, { month: "long" });
              if (m - 1 == currentMonth)
                option.selected = true;
          ...
          renderCalendar(date) {
            ...
            for (let i = firstDayOfMonth; i > 0; i--) {
              ...
              const date2 = `${month == 0 ? year - 1 : year}-${month == 0 ? 12 : String(month).padStart(2, "0")}-${String(lastDateOfLastMonth - i + 1).padStart(2, "0")}`;
              d.addEventListener("click", (e) => {
                e.preventDefault();
                this.dayChange(date2);
              });
              calendar.append(d);
            }
            for (let i = 1; i <= lastDateOfMonth; i++) {
              ...
              d.setAttribute("curr", "");
              d.textContent = i;
              const date2 = `${year}-${String(month + 1).padStart(2, "0")}-${String(i).padStart(2, "0")}`;
              if (today === date2)
            ...
            for (let i = lastDayOfMonth; i < 6; i++) {
              ...
              const date2 = `${month == 11 ? year + 1 : year}-${month == 11 ? String(1).padStart(2, "0") : String(month + 2).padStart(2, "0")}-${String(i - lastDayOfMonth + 1).padStart(2, "0")}`;
              d.addEventListener("click", (e) => {
                e.preventDefault();
                this.dayChange(date2);
              });
          ...
          manualDate(e) {
            ...
            if (e.key == "ArrowUp") {
              if (e.target.value == "")
                return;
              date = new Date(Date.parse(this.reverse ? this.reverseDate(date) : date) + 864e5).toISOString().split("T")[0];
              this.dayChange(date);
            }
            if (e.key == "ArrowDown") {
              if (e.target.value == "")
          ...
          calculateDate(days = 0) {
            const newDate = new Date(Date.parse(this.date) + days * 864e5).toISOString().split("T")[0];
            return newDate;
          }
...
// src/assets/js/components/as-dot-matrix-clock-component.js
var require_as_dot_matrix_clock_component = __commonJS({
  "src/assets/js/components/as-dot-matrix-clock-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-dot-matrix-clock") === void 0) {
        class ASDotMatrixClock extends HTMLElement {
          ...
          init() {
            ...
            this._interval = setInterval(() => this.setClock(), 1e3);
          }
          generateDigitsGrid() {
            const rows = 5;
            const cols = 4;
...
// src/assets/js/components/as-drawer-component.js
var require_as_drawer_component = __commonJS({
  "src/assets/js/components/as-drawer-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-drawer") === void 0) {
...
// src/assets/js/components/as-form-validation-component.js
var require_as_form_validation_component = __commonJS({
  "src/assets/js/components/as-form-validation-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-form-validation") === void 0) {
...
// src/assets/js/components/as-gauge-component.js
var require_as_gauge_component = __commonJS({
  "src/assets/js/components/as-gauge-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-gauge") === void 0) {
        class ASGauge extends HTMLElement {
          connectedCallback() {
            ...
            this.settings.delay = this.getAttribute("delay") || 1e3;
            ...
            this.settings.path = `path("M${this.settings.basesize * this.settings.size * 0.5},${this.settings.basesize * this.settings.size * 0.12}A${this.settings.basesize * this.settings.size * 0.38},${this.settings.basesize * this.settings.size * 0.38},0,1,0,${this.settings.basesize * this.settings.size * 0.88},${this.settings.basesize * this.settings.size * 0.5},${this.settings.basesize * this.settings.size * 0.38},${this.settings.basesize * this.settings.size * 0.38},0,0,0,${this.settings.basesize * this.settings.size * 0.5},${this.settings.basesize * this.settings.size * 0.12}M${this.settings.basesize * this.settings.size * 0.5},0A${this.settings.basesize * this.settings.size * 0.5},${this.settings.basesize * this.settings.size * 0.5},0,1,1,0,${this.settings.basesize * this.settings.size * 0.5},${this.settings.basesize * this.settings.size * 0.5},${this.settings.basesize * this.settings.size * 0.5},0,0,1,${this.settings.basesize * this.settings.size * 0.5},0Z")`;
            this.init();
          }
          isColorVar(color) {
...
// src/assets/js/components/as-graph-component.js
var require_as_graph_component = __commonJS({
  "src/assets/js/components/as-graph-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      ...
      class ASGraph extends HTMLElement {
        ...
        init() {
          ...
          this.style.setProperty("--transition-duration", Number(this.transitionDuration / 1e3) + "s");
        ...
        drilldown(label, data, index) {
          this.prevData[this.level] = { data: this.data, resolution: this.resolution, label, index, title: this.chartTitle, xtitle: this.chartX, ytitle: this.chartY, palette: this.palette };
          this.level += 1;
          this.data = data.data;
          this.resolution = this.data.length;
          this.index = 0;
          ...
          for (let i = this.index; i < Math.min(this.index + this.resolution, this.data.length); i++) {
            ...
            this.inEvents.forEach((event) => {
              column.addEventListener(event, (evt) => {
                ...
                column.style.setProperty("--transition-delay", "0ms");
            ...
            if (drilldown) {
              ...
              column.addEventListener("click", () => {
                this.drilldown(label, drilldown);
              });
            }
          ...
          for (let i = this.index; i < Math.min(this.index + this.resolution, this.data.length); i++) {
            ...
            this.inEvents.forEach((event) => {
              legendEl.addEventListener(event, (evt) => {
                ...
                pie.style.setProperty("--transition-delay", "0ms");
              });
            });
            this.outEvents.forEach((event) => {
              legendEl.addEventListener(event, (evt) => {
            ...
            if (drilldown) {
              legendEl.style.cursor = "zoom-in";
              legendEl.addEventListener("click", () => {
                this.drilldown(label, drilldown, this.index);
              });
            }
            legend.appendChild(legendEl);
          }
...
// src/assets/js/components/as-icon-component.js
var require_as_icon_component = __commonJS({
  "src/assets/js/components/as-icon-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-icon") === void 0) {
...
// src/assets/js/components/as-panel-component.js
var require_as_panel_component = __commonJS({
  "src/assets/js/components/as-panel-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-panel") === void 0) {
...
// src/assets/js/components/as-popout-component.js
var require_as_popout_component = __commonJS({
  "src/assets/js/components/as-popout-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-popout") === void 0) {
...
// src/assets/js/components/as-relative-time-component.js
var require_as_relative_time_component = __commonJS({
  "src/assets/js/components/as-relative-time-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-relative-time") === void 0) {
        class ASRelativeTimeElement extends HTMLElement {
          constructor() {
            super();
            this.ready = false;
            this.dateTime = this.innerHTML || this.getAttribute("datetime") || (/* @__PURE__ */ new Date()).toISOString();
          }
          connectedCallback() {
            ...
            this.update = this.hasAttribute("update") ? Number(this.getAttribute("update")) * 6e4 : 0;
            this.scales = {
              sec: 1e3,
              min: 1e3 * 60,
              hour: 1e3 * 60 * 60,
          ...
          render() {
            this.hasAttribute("relative") ? this.textContent = this.calculateRelativeTime() : this.textContent = this.hasAttribute("notime") ? this.dateTime.split("T")[0] : this.dateTime;
...
// src/assets/js/components/as-search-menu-component.js
var require_as_search_menu_component = __commonJS({
  "src/assets/js/components/as-search-menu-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-search-menu") === void 0) {
...
// src/assets/js/components/as-select-component.js
var require_as_select_component = __commonJS({
  "src/assets/js/components/as-select-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-select") === void 0) {
        class ASSelectElement extends HTMLElement {
          ...
          addEventListeners() {
            ...
            calcEvents.forEach(
              (event) => window.addEventListener(event, this.calculateSelectDropdownPosition.bind(this))
            );
          ...
          propagateSelectDropdown(e) {
            ...
            if (e !== null && e.type == "input" && (e.code != "ArrowDown" || e.code != "ArrowUp")) {
              ...
              this.broadcastEvent("as-select:search", { id: this.selectId, action: "search", searchword }, false);
          ...
          broadcastEvent(name, detail = {}, bubbles = true) {
            const cEvent = this.isEmpty(detail) ? new CustomEvent(name, { bubbles }) : new CustomEvent(name, { detail, bubbles });
            this.dispatchEvent(cEvent);
          }
        }
...
// src/assets/js/components/as-select-multiple-component.js
var require_as_select_multiple_component = __commonJS({
  "src/assets/js/components/as-select-multiple-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-select-multiple") === void 0) {
        class ASSelectMultiple extends HTMLElement {
          ...
          populateDropdown(filter = "") {
            ...
            const frag = new DocumentFragment();
            Array.from(this.select.options).filter((opt) => !opt.selected && opt.text.toLowerCase().includes(filter.toLowerCase())).forEach((opt) => {
...
// src/assets/js/components/as-select2range-component.js
var require_as_select2range_component = __commonJS({
  "src/assets/js/components/as-select2range-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-select2range") === void 0) {
...
// src/assets/js/components/as-show-hide-password-component.js
var require_as_show_hide_password_component = __commonJS({
  "src/assets/js/components/as-show-hide-password-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-show-hide-password") === void 0) {
...
// src/assets/js/components/as-svg-to-base-component.js
var require_as_svg_to_base_component = __commonJS({
  "src/assets/js/components/as-svg-to-base-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-svg-to-base") === void 0) {
...
// src/assets/js/components/as-tab-component.js
var require_as_tab_component = __commonJS({
  "src/assets/js/components/as-tab-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-tab") === void 0) {
...
// src/assets/js/components/as-tab-group-component.js
var require_as_tab_group_component = __commonJS({
  "src/assets/js/components/as-tab-group-component.js"() {
    if (window.customElements.get("as-tab-group") === void 0) {
...
// src/assets/js/components/as-table-actions-component.js
var require_as_table_actions_component = __commonJS({
  "src/assets/js/components/as-table-actions-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-table-actions") === void 0) {
            ...
            document.addEventListener("as-popout:created", (e) => {
              setTimeout(() => {
                if (e.detail.id === `pop_${this.tableActionsId}`) {
                  ...
                  this.buttonMD.addEventListener("click", (e2) => this.downloadMD(e2));
                  this.buttonCSV.addEventListener("click", (e2) => this.downloadCSV(e2));
                  this.buttonEXCEL.addEventListener("click", (e2) => this.downloadEXCEL(e2));
                  this.buttonCOPY.addEventListener("click", (e2) => this.copy(e2));
                }
              }, 1);
              document.addEventListener("as-popout:toggle", (e2) => this.broadcastEvent("as-table-actions:popover", { id: this.tableActionsId, state: e2.detail.state }));
              this.ready = true;
            });
          }
          downloadCSV(e) {
...
// src/assets/js/components/as-table-sort-component.js
var require_as_table_sort_component = __commonJS({
  "src/assets/js/components/as-table-sort-component.js"() {
    document.addEventListener("DOMContentLoaded", () => {
      if (window.customElements.get("as-table-sort") === void 0) {
        class ASTableSort extends HTMLElement {
          ...
          sortTable(btn, index = 0) {
            ...
            btns.forEach((btn2) => {
              btn2.firstChild.setAttribute("new-name", "--as-icon-arrows-up-down");
            });
...
// src/assets/js/components/as-toast-component.js
var require_as_toast_component = __commonJS({
  "src/assets/js/components/as-toast-component.js"() {
    if (!window.AS.Toast) {
      class Toast2 {
        ...
        render() {
          ...
          toast.style.setProperty("--delay", Math.round(this.timeout / 1e3) + "s");
          this.toastWrapper.prepend(toast);
          const gauge = document.createElement("as-gauge");
          gauge.textContent = Math.round(this.timeout / 1e3);
          gauge.setAttribute("size", 1.5);
          gauge.setAttribute("delay", 0);
          gauge.setAttribute("max", Math.round(this.timeout / 1e3));
          if (this.sticky) {
            ...
            close.addEventListener("click", () => {
              ...
              setTimeout(() => toast.remove(), 1e3);
            });
            toast.append(close);
          } else {
            toast.prepend(gauge);
            let val = Math.round(this.timeout / 1e3);
            setInterval(() => {
              val--;
            ...
            setTimeout(() => toast.remove(), this.timeout + 1e3);
          }
        }
      }
      window.AS.Toast = Toast2;
      window.Toast = Toast2;
    }
  }
});

// src/assets/js/components/as-window-component.js
var require_as_window_component = __commonJS({
  "src/assets/js/components/as-window-component.js"() {
    window.AS = window.AS || {};
  }
});

// src/assets/js/components/components-entry.js
var import_as_carousel_component = __toESM(require_as_carousel_component());
...
var import_as_date_picker_component = __toESM(require_as_date_picker_component());
var import_as_dot_matrix_clock_component = __toESM(require_as_dot_matrix_clock_component());
var import_as_drawer_component = __toESM(require_as_drawer_component());
var import_as_form_validation_component = __toESM(require_as_form_validation_component());
var import_as_gauge_component = __toESM(require_as_gauge_component());
var import_as_graph_component = __toESM(require_as_graph_component());
var import_as_icon_component = __toESM(require_as_icon_component());
var import_as_panel_component = __toESM(require_as_panel_component());
var import_as_popout_component = __toESM(require_as_popout_component());
var import_as_relative_time_component = __toESM(require_as_relative_time_component());
var import_as_search_menu_component = __toESM(require_as_search_menu_component());
var import_as_select_component = __toESM(require_as_select_component());
var import_as_select_multiple_component = __toESM(require_as_select_multiple_component());
var import_as_select2range_component = __toESM(require_as_select2range_component());
var import_as_show_hide_password_component = __toESM(require_as_show_hide_password_component());
var import_as_svg_to_base_component = __toESM(require_as_svg_to_base_component());
var import_as_tab_component = __toESM(require_as_tab_component());
var import_as_tab_group_component = __toESM(require_as_tab_group_component());
var import_as_table_actions_component = __toESM(require_as_table_actions_component());
var import_as_table_sort_component = __toESM(require_as_table_sort_component());
var import_as_toast_component = __toESM(require_as_toast_component());
var import_as_window_component = __toESM(require_as_window_component());
